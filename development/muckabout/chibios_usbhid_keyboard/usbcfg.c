...
#define USB_INTERFACE_DESCRIPTOR_SIZE                                       \
  (USB_DESC_INTERFACE_SIZE + HID_DESCRIPTOR_SIZE + USB_DESC_ENDPOINT_SIZE)

/* Configuration Descriptor tree for a HID device */
static const uint8_t hid_configuration_descriptor_data[] = {
  /* Configuration Descriptor */
  USB_DESC_CONFIGURATION(USB_DESC_CONFIGURATION_SIZE +
                         USB_INTERFACE_DESCRIPTOR_SIZE,  /* wTotalLength.   */
                         0x01,          /* bNumInterfaces.              */
...
static const uint8_t vcom_string1[] = {
  ...
  USB_DESC_BYTE(USB_DESCRIPTOR_STRING), /* bDescriptorType.                 */
  'S', 0, 'T', 0, 'M', 0, '3', 0, '2', 0, 'F', 0, '4', 0, '1', 0,
  '1', 0, ' ', 0, 'B', 0, 'l', 0, 'a', 0, 'c', 0, 'k', 0, 'P', 0,
  'i', 0, 'l', 0, 'l', 0
};
...
static bool requests_hook(USBDriver *usbp) {
  ...
  if ((usbp->setup[0] & (USB_RTYPE_DIR_MASK | USB_RTYPE_TYPE_MASK)) ==
      (USB_RTYPE_DIR_DEV2HOST | USB_RTYPE_TYPE_STD)) {
