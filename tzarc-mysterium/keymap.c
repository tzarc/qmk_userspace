...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FUNC1] = LAYOUT_tkl_ansi(
      ...
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RESET,  KC_TRNS,KC_TRNS,KC_TRNS,KC_P7,  KC_P8,   KC_P9,   KC_PSLS,  KC_PAST, KC_TRNS,  KC_TRNS,  KC_TRNS, KC_TRNS,
      KC_CAPS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_P4,  KC_P5,   KC_P6,   KC_PPLS,  KC_TRNS,
      KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_P0,  KC_P1,   KC_P2,   KC_P3,    KC_PMNS,                     KC_VOLU,
