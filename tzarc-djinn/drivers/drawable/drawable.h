...
typedef void (*drawable_pixdata_func)(drawable_driver_t *driver, const uint8_t *pixel_data, uint32_t num_pixels);
...
void drawable_pixdata(drawable_driver_t *driver, const uint8_t *pixel_data, uint32_t num_pixels);
