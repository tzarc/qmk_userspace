...
static const uint8_t gfx_lock_num_OFF_data[238] QP_RESIDENT_FLASH = {
...
painter_image_t gfx_lock_num_OFF QP_RESIDENT_FLASH = (painter_image_t)&gfx_lock_num_OFF_raw;
