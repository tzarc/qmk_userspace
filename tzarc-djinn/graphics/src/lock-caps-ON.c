...
static const uint8_t gfx_lock_caps_ON_data[243] QP_RESIDENT_FLASH = {
...
static const painter_raw_image_descriptor_t gfx_lock_caps_ON_raw QP_RESIDENT_FLASH = {
    .base = {
...
painter_image_t gfx_lock_caps_ON QP_RESIDENT_FLASH = (painter_image_t)&gfx_lock_caps_ON_raw;
