...
#if defined(__LINUX__) || defined(_MSC_VER)
#   define GIF_HAS_FILE_IO TRUE
#endif

#ifdef _MSC_VER
#  define __builtin_bswap16(x) ((((x)&0xFF) << 8) | (((x) & 0xFF00) >> 8))
#endif
...
// Forward declaration
typedef struct gif_image_tag GIFIMAGE;
...
typedef void(GIF_DRAW_CALLBACK)(GIFDRAW* pDraw, GIFIMAGE* pImage, void* pExtData);
