...
#define ____________TZARC_LOWER_R2_ALPHA_________ _______, ____________TZARC_FKEYS__________________, _______
#define ____________TZARC_LOWER_R2_NAV___________ _______, _______, _______

#define ____________TZARC_LOWER_R3_ALPHA_________ _______, KC_NOMODE, KC_CONFIG, KC_WOWMODE, KC_D3MODE, _______, _______, _______, _______, _______, _______, _______, _______, _______
