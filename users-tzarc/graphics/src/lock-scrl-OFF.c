...
static const uint8_t gfx_lock_scrl_OFF_data[244] QP_RESIDENT_FLASH = {
...
static const painter_raw_image_descriptor_t gfx_lock_scrl_OFF_raw QP_RESIDENT_FLASH = {
    .base = {
...
painter_image_t gfx_lock_scrl_OFF QP_RESIDENT_FLASH = (painter_image_t)&gfx_lock_scrl_OFF_raw;
