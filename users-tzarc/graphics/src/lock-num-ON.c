...
static const uint8_t gfx_lock_num_ON_data[256] QP_RESIDENT_FLASH = {
...
static const painter_raw_image_descriptor_t gfx_lock_num_ON_raw QP_RESIDENT_FLASH = {
    .base = {
...
painter_image_t gfx_lock_num_ON QP_RESIDENT_FLASH = (painter_image_t)&gfx_lock_num_ON_raw;
