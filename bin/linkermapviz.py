#!/usr/bin/env python3
# Copyright 2018 @PromyLOPh
# SPDX-License-Identifier: MIT
# Originally from: https://github.com/PromyLOPh/linkermapviz/blob/master/linkermapviz/__init__.py
# Original content starts below the dotted line...
# ------------------------------------------------------------------------------#
...
def main() -> None:
    ...
    for s in whitelistedSections:
        ...
        p = figure(
            title="Linker map for section {} ({} bytes)".format(s.section, totalsize),
            plot_width=width,
            plot_height=height,
