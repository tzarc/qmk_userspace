...
[[ -f qmk_toolchain-gcc13.2.0-host_$(fn_os)$(fn_arch)-target_baremetalARM.tar.xz ]] ||
    ...
    curl -fsSLO https://github.com/tzarc/qmk_toolchains/releases/download/${tag_name}/qmk_toolchain-gcc13.2.0-host_$(fn_os)$(fn_arch)-target_baremetalARM.tar.xz
[[ -f qmk_toolchain-gcc13.2.0-host_$(fn_os)$(fn_arch)-target_baremetalAVR.tar.xz ]] ||
    echo "Downloading AVR toolchain" &&
    curl -fsSLO https://github.com/tzarc/qmk_toolchains/releases/download/${tag_name}/qmk_toolchain-gcc13.2.0-host_$(fn_os)$(fn_arch)-target_baremetalAVR.tar.xz
[[ -f qmk_toolchain-gcc13.2.0-host_$(fn_os)$(fn_arch)-target_baremetalRV32.tar.xz ]] ||
    echo "Downloading RISC-V toolchain" &&
    curl -fsSLO https://github.com/tzarc/qmk_toolchains/releases/download/${tag_name}/qmk_toolchain-gcc13.2.0-host_$(fn_os)$(fn_arch)-target_baremetalRV32.tar.xz
...
if [[ $(fn_os) == "linux" ]]; then
    [[ -f qmk_toolchain-gcc13.2.0-host_$(fn_os)$(fn_arch)-target_$(fn_os)$(fn_arch).tar.xz ]] ||
        ...
        curl -fsSLO https://github.com/tzarc/qmk_toolchains/releases/download/${tag_name}/qmk_toolchain-gcc13.2.0-host_$(fn_os)$(fn_arch)-target_$(fn_os)$(fn_arch).tar.xz
