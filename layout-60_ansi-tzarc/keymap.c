...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT_60_ansi(
    ...
    KC_TAB_LOWER, KC_Q,    KC_W,    KC_E,        KC_R,       KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,    KC_BSLS,
    KC_CTL_ESC,   KC_A,    KC_S,    KC_D,        KC_F,       KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,             KC_ENT,
    KC_LSFT,      KC_Z,    KC_X,    KC_C,        KC_V,       KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,                      KC_RSFT,
    KC_LCTL,      KC_LGUI, KC_LALT,                                   KC_SPC,                             KC_RALT, KC_RGUI,KC_APP_RAISE,KC_RCTL
  ),

  [LAYER_LOWER] = LAYOUT_60_ansi(
  ...
  [LAYER_ADJUST] = LAYOUT_60_ansi(
    _______,      _______, _______, _______,     _______,    _______, _______, _______, _______, _______, _______, _______, TIME_EEPRST,TIME_RESET,
